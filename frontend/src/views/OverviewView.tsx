    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <h3 className="text-base font-semibold text-gray-900 mb-1">Average Ranking Trajectory</h3>
                <p className="text-xs text-gray-400 mb-4">Macro ranking trend over check-in dates across tracked catalog. Lower rank value indicates higher SERP position.</p>
